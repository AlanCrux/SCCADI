...
public class IUAdministrarAlumnosController implements Initializable {
    ...
    public void eliminarAlumno() {
        ...
        for (int i = 0; i < listaAlumno.size(); i++) {
            if (listaAlumno.get(i).getMatricula().equals(seleccionado.getMatricula())) {
                ...
                boolean eliminarAlumno = alumno.eliminarAlumno(seleccionado.getMatricula());
                if (eliminarAlumno) {
    ...
    /**
     * Este metodo nos permite editar la informacion de un alumno registrado 
     * en la base de datos 
     */
    @FXML
    ...
    /**
     * Este metodo obtiene la informacion proporcionada en la pantalla y crea
