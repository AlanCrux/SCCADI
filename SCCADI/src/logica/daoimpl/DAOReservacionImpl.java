...
public class DAOReservacionImpl extends Conexion implements DAOReservacion {
    ...
    public List<Reservacion> obtenerReservacionesPorAlumno(String matricula) throws Exception {
        String query = "select actividadasignada.fecha, reservacion.idReservacion, reservacion.idActividadAsignada, reservacion.matricula,reservacion.asistio, actividadprogramada.nombre from reservacion join "
                + "actividadprogramada join actividadasignada where actividadasignada.idActividadAsignada = reservacion.idActividadAsignada and actividadprogramada.idActividadProgramada = "
                + "actividadasignada.idActividadProgramada and reservacion.matricula = ?;";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                reservacion.setAsistio(rs.getBoolean("asistio"));
                reservacion.setNombre(rs.getString("nombre"));
